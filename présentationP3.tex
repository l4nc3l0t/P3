...
\begin{frame}{\insertsubsection}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{NutriPie}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{\insertsubsection}
  \begin{columns}
    \begin{column}{.55\textwidth}
      ...
      \begin{table}
        \tiny
        \input{./Tableaux/ANOVANutriScoreGrade}
    ...
    \begin{column}{.45\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{NutriBox}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{\insertsubsubsection}
  \begin{columns}
    ...
    \end{column}
    \begin{column}{.5\textwidth}
      \includegraphics[width=.98\textwidth]{HeatmapNum}
    \end{column}
  \end{columns}  
\end{frame}
...
\begin{frame}{\insertsubsubsection}
  \begin{columns}
    \begin{column}{.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{SelReg}
        \includegraphics[width=\textwidth]{GrasReg}
      \end{figure}      
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{SucreReg}
        \includegraphics[width=\textwidth]{EnergyFatReg}
      \end{figure}      
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{\insertsubsubsection}
  \begin{columns}
    \begin{column}{.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{NutriEnergyReg}
        \includegraphics[width=\textwidth]{NutriSucreReg}
      \end{figure}
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{figure}
        \includegraphics[width=\textwidth]{NutriGrasReg}
        \includegraphics[width=\textwidth]{NutriSelReg}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
